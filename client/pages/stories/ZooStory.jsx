...
export default function ZooStory() {
  ...
  return (
    <div>
      ...
      <input type="text" name="verb2" placeholder="Enter a verb" value={userData.verb2} onChange={handleInputChange}/>
      <input type="text" name="adverb2" placeholder="Enter an adverb" value={userData.adverb2} onChange={handleInputChange}/>
      <input type="text" name="verb3" placeholder="Enter a verb" value={userData.verb3} onChange={handleInputChange}/>
